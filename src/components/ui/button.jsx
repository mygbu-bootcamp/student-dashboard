...
const buttonVariants = (options) => {
  ...
  const variantStyles = {
    ...
    destructive: "bg-destructive text-destructive-foreground hover:bg-destructive/90 border border-red-400 bg-red-400",
  ...
  return cn(
    baseStyles,
    variantStyles[options?.variant || "default"],
    sizeStyles[options?.size || "default"]
  );
};
