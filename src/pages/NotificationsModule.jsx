...
import {
    ...
    ChevronDown,
    ChevronUp,
    Clock // Added Clock icon for 'Pending' or 'All' stats if needed
} from "lucide-react";
    ...
    ({ className = "", value, parentProps, children, ...props }, ref) => {
        ...
        return (
            <button
                ...
                onClick={handleClick} // This is where handleClick is used
    ...
    return (
        <div className="space-y-6 px-4 sm:px-6 lg:px-1 max-w-7xl mx-auto">
            ...
            <div className="grid grid-cols-2 sm:grid-cols-4 gap-2 sm:gap-4">
                ...
                <StatsCard
                    title="Actionable"
                    value={notifications.filter(n => n.actionable).length}
                    icon={CheckCircle}
                ...
                <div className="p-3 sm:p-4">
                    <div className="flex flex-col sm:flex-row gap-2 sm:gap-4">
                        ...
                        <div className="flex gap-1 sm:gap-2">
                            <button className="inline-flex items-center justify-center rounded-md border border-gray-300 bg-white px-3 py-2 text-xs sm:text-sm font-medium text-gray-700 hover:bg-gray-50 focus:outline-none focus:ring-2 focus:ring-black transition-all duration-200 ease-in-out hover:shadow-sm hover:scale-[1.02] cursor-pointer">
                                <Filter className="mr-1 sm:mr-2 h-3 w-3 sm:h-4 sm:w-4" />
                                <span className="hidden sm:inline">Filter</span>
                            </button>
                            <button
                                onClick={handleMarkAllRead}
                                className="inline-flex items-center justify-center rounded-md border border-gray-300 bg-white px-3 py-2 text-xs sm:text-sm font-medium text-gray-700 hover:bg-gray-50 focus:outline-none focus:ring-2 focus:ring-black transition-all duration-200 ease-in-out hover:shadow-sm hover:scale-[1.02] cursor-pointer"
                            >
            ...
            <div className="sm:hidden">
                <button
                    className="w-full flex items-center justify-between rounded-md border border-gray-300 bg-white px-4 py-2 text-sm font-medium text-gray-700 hover:bg-gray-50 focus:outline-none focus:ring-2 focus:ring-black transition-all duration-200 ease-in-out hover:shadow-sm hover:scale-[1.02] cursor-pointer"
                ...
                {showMobileMenu && (
                    <div className="mt-2 space-y-1">
                        {categories.map((category) => (
                            <button
                                key={category.id}
                                className={`w-full text-left px-4 py-2 text-sm rounded-md ${activeTab === category.id
                ...
                {filteredNotifications.length === 0 ? (
                    ...
                    filteredNotifications.map((notification) => {
                        ...
                        return (
                            <div
                                key={notification.id}
                                className={`bg-white rounded-lg border ${!notification.read ? 'border-blue-200 bg-blue-50' : 'border-gray-200'
                                    } `}
                            >
                                <div className="p-3 sm:p-4">
                                            ...
                                            <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-2">
                                                <div className="flex gap-1 sm:gap-2">
                                                    {notification.actionable && (
                                                        <button className="inline-flex items-center rounded-md border border-transparent bg-black px-3 py-1.5 text-xs sm:text-sm font-medium text-white hover:bg-black/80 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-offset-2 transition-all duration-200 ease-in-out hover:shadow-sm hover:scale-[1.02] cursor-pointer">
                                                    ...
                                                    {!notification.read && (
                                                        <button
                                                            ...
                                                            className="inline-flex items-center rounded-md border border-gray-300 bg-white px-3 py-1.5 text-xs sm:text-sm font-medium text-gray-700 hover:bg-gray-50 focus:outline-none focus:ring-2 focus:ring-blue-500 transition-all duration-200 ease-in-out hover:shadow-sm hover:scale-[1.02] cursor-pointer"
                                                        >
                                                            Mark as Read
                                                        </button>
                                                    )}
                                                ...
                                                <div className="flex gap-0.5 sm:gap-1">
                                                    <button className="rounded-md p-1.5 sm:p-2 text-gray-400 hover:text-gray-500 hover:bg-gray-100 transition-all duration-200 ease-in-out hover:shadow-sm hover:scale-[1.02] cursor-pointer">
                                                        <Archive className="h-3 w-3 sm:h-4 sm:w-4" />
                                                    </button>
                                                    <button
                                                        onClick={() => handleDeleteNotification(notification.id)}
                                                        className="rounded-md p-1.5 sm:p-2 text-gray-400 hover:text-gray-500 hover:bg-gray-100 transition-all duration-200 ease-in-out hover:shadow-sm hover:scale-[1.02] cursor-pointer"
                                                    >
                            ...
                            <div className="space-y-2 sm:space-y-3">
                                <div className="flex items-center justify-between">
                                    ...
                                    <button
                                        ...
                                        className={`inline-flex items-center rounded-md border ${notificationSettings.push ? 'border-blue-500 bg-blue-500 text-white' : 'border-gray-300 bg-white text-gray-700'
                                            } px-3 py-1 text-xs sm:text-sm font-medium hover:opacity-80 transition-all duration-200 ease-in-out hover:shadow-sm hover:scale-[1.02] cursor-pointer`}
                                    >
                                ...
                                <div className="flex items-center justify-between">
                                    ...
                                    <button
                                        ...
                                        className={`inline-flex items-center rounded-md border ${notificationSettings.email ? 'border-blue-500 bg-blue-500 text-white' : 'border-gray-300 bg-white text-gray-700'
                                            } px-3 py-1 text-xs sm:text-sm font-medium hover:opacity-80 transition-all duration-200 ease-in-out hover:shadow-sm hover:scale-[1.02] cursor-pointer`}
                                    >
                                ...
                                <div className="flex items-center justify-between">
                                    ...
                                    <button
                                        ...
                                        className={`inline-flex items-center rounded-md border ${notificationSettings.sms ? 'border-blue-500 bg-blue-500 text-white' : 'border-gray-300 bg-white text-gray-700'
                                            } px-3 py-1 text-xs sm:text-sm font-medium hover:opacity-80 transition-all duration-200 ease-in-out hover:shadow-sm hover:scale-[1.02] cursor-pointer`}
                                    >
                            ...
                            <div className="space-y-2 sm:space-y-3">
                                <div className="flex items-center justify-between">
                                    ...
                                    <select
                                        ...
                                        className="rounded-md border border-gray-300 bg-white px-3 py-1 text-xs sm:text-sm font-medium text-gray-700 focus:outline-none focus:ring-2 focus:ring-blue-500 cursor-pointer"
                                    >
